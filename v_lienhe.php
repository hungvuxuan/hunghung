...
<div id="form-wrapper" class="lienhe">
    <form method="post" action="">
        <div id="form-inner">
            ...
            <input type="text" class="input" value="<?php echo isset($arr_khachhang["fullname"])? $arr_khachhang["fullname"]:""; ?>" name="name" placeholder="Vu Xuan Hung" required>
        
            <label for="email">Email:</label>
            <input type="email" class="input" value="<?php echo isset($arr_khachhang["email"])? $arr_khachhang["email"]:""; ?>" name="email" placeholder="hungvu@email.com" required>
