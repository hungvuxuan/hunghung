...
<body>
	...
	<div class="all">
		<div id="divAdRight" style="display: block; position: fixed; margin-top:52px;">
			<a href="#"><img src="images\images_hung\5.jpg" width="120" /></a>
		</div>
		<div id="divAdLeft" style="display: block; position: fixed;margin-top:52px;">
			<a href="#"><img src="images\images_hung\tin2.jpg" width="120" /></a>
		</div>
		<script>
...
<div class="dn">
	<div class="user">  <!--Box chức năng đăng ký / đăng nhập  -->
		<ul>
			<li><?php 
				...
				{
				?>
				<a href="khach-hang.html"><img  style="float:left; margin-top:10px; font-style: italic; color:#B0E0E6" src="images/images_html/2.png" width="10" height="10"></a>
	...
	<div class="cart">  <!-- box giỏ hàng  -->
		...
		<span  style="text-align:center; line-height:50px; color:red; margin-left:10px;" class="tb">Có <strong style="color:#F00">
			<?php 
