	...
	<div class="center">
		<div class="phukien">
			...
			<div class="phukien">
				...
				<div class="mypham">				
					<!-- Mỹ Phẩm Nổi Bật -->
					<div class="sp2"><a href="#"><p style="color:#FFF; text-align:left; line-height:30px; font-weight:bold; padding-left:10px;">Kiểu Tóc Nổi Bật</p></a></div>
					<?php 
							...
							<div class="box_online">
								<ul>
									<li>
										...
										<b style="color:#00D936;">Ngô Thị Phương Anh</b>
									</li>
									<li>
										...
										<span style="color:#00F; font-weight:bold;">Bán Hàng Online</span>
										<a href=”ymsgr:sendIM?mongmotngaygapem_90“><img style="margin-top:5px; margin-bottom:5px;" border=”0″ src="images/images_html/yahoo_online.gif"></a>
										<b style="color:#00D936;">Vũ Xuân Hưng</b>
									</li>
								</ul>
							</div>
								...
								<ul>
									<li><img src="images/images_html/list-style-image.png" height="10" width="10">Số Lượng Online :
										...
										$tgnew=$tg - $tgout;
											...
											?></li>
											<li><img src="images/images_html/list-style-image.png" height="10" width="10">Số Lượng Truy Cập : 999999</li>
										</ul>
									</div>
									<div class="box_qc" style="float:left; margin-top:10px;"><a href="#"><img src="images/images_qc/4.jpg" height="300" width="203"></a></div>
								</div>
